...
11. 报错You do not have the SUPER privilege and binary logging is enabled (you *might* want to use the less safe log_bin_trust_function_creators variable
```shell
2023-03-08 11:08:21.977 [main] INFO  i.j.JpomServerApplication [StartupInfoLogger.java:55] - Starting JpomServerApplication v2.10.26 using Java 1.8.0_121 on ldap.rtsrt.cn with PID 12073 (/usr/local/jpom-server/lib/Server-2.10.26.jar started by root in /usr/local/jpom-server)
...
2023-03-08 11:08:25.358 [main] INFO  i.j.c.JpomApplicationEvent [JpomApplicationEvent.java:139] - 本机安装 ID 为：8bef720e928b46c5942ecbcb36640c99
