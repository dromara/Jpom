...
notices: # 可选的
  - id: jpom-2.10.17
    title: 📢 Jpom v2.10.17 发布！
    content: '<div><p>2023-02-16</p><ul><li>本地构建产物模糊匹配规则优化</li><li>构建日志输出环境变量</li></ul></div><p style="text-align: right;"><a href="/pages/changelog/new/">查看详情</a>&nbsp;&nbsp;<a href="/pages/all-downloads/">下载安装包</a></p>'
    isHtmlContent: true
---
