...
* [👍如何使用 Jpom 的在线构建为 Jpom 发版](/pages/practice/build-jpom/)

### 本地构建

* [本地构建 + SSH 发布 java 项目](/pages/practice/build-java-ssh-release/)
* [本地构建 + Jpom Server 使用 SCP 发布项目](/pages/practice/jpom-server-scp-upload/)
...
* [GitLab 提交代码后自动执行构建](/pages/practice/gitlab-webhook-trigger-build/)
...
* [DSL 实现管理 Tomcat ](/pages/dc2836/)
* [DSL 实现管理 elasticsearch ](/pages/8017a2/)
...
* [使用构建发布 docker 镜像并推送到远程仓库](/pages/practice/9c1640/)
* [建web镜像并推送至仓库](/pages/practice/9c1641/)
