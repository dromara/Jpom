...
```json
{"code":405,"data":{"msgs":["当前程序正常运行中，不能重复启动,PID:1341336","stop done,but unsuccessful","running:1341336 1341396"],"success":false},"msg":"上传成功并重启"}
```

```json
{"code":405,"data":{"msgs":["restart done,but unsuccessful","running:1341336 1341396"],"success":false}}
```
