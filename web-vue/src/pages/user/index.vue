<template>
  <div>
    ...
    <!-- 数据表格 -->
    <a-table :data-source="list" :loading="loading" :columns="columns" :style="{'max-height': tableHeight + 'px' }" :scroll="{x: 960, y: tableHeight - 60}" :pagination="false" bordered :rowKey="(record, index) => index">
