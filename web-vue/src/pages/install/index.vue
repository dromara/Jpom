  ...
  <div class="init-wrapper">
    ...
    <a-form :form="loginForm" :label-col="{ span: 0 }" @submit="handleLogin" class="init-form">
      ...
      <a-form-item :wrapper-col="{span: 24}" class="init-user-password">
        <a-input-password v-decorator="['userPwd', { rules: [{ required: true, message: '请输入密码' }, {pattern: /^(?![\d]+$)(?![a-zA-Z]+$)(?![^\da-zA-Z]+$).{6,18}$/, message: '密码必须包含数字，字母，字符，且大于6位'}] }]" placeholder="密码（6-18位数字、字母、符号组合）"/>
      </a-form-item>
