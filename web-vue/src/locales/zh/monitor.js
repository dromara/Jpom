export default {
    ...
    log: {
        selectNode: "请选择节点",
        notifyUser: "如果这里的报警联系人无法选择，说明这里面的管理员没有设置邮箱，在右上角下拉菜单里面的用户资料里可以设置。"
    },
    operate_log: {
        introGuide:"这里面的报警联系人如果无法选择，您需要设置管理员的邮箱地址。",
        monitorUser: "请选择监控用户",
        methodFeature:"请选择监控操作",
        classFeature:"请选择监控的功能",
        notifyUser: "请选择报警联系人",
        deleteContents:"真的要删除操作监控吗？"
    }
};
