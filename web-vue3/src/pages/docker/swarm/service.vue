  ...
  <div>
    ...
    >
      <a-form ref="editForm" :rules="rules" :model="temp" :label-col="{ span: 4 }" :wrapper-col="{ span: 18 }">
        ...
        <a-form-item label="运行模式" prop="mode">
        ...
        <a-form-item label="镜像名称" prop="image">
          <a-input v-model="temp.image" placeholder="镜像名称" />
        </a-form-item>
        <a-form-item label="更多配置" prop="">
          <a-tabs>
            <a-tab-pane key="port" tab="端口">
              <a-form-item label="解析模式" prop="endpointResolutionMode">
                <a-radio-group
            ...
            <a-tab-pane key="update" tab="升级策略" v-if="temp.update">
              <a-form-item label="并行度" prop="parallelism">
                <a-input-number
                  style="width: 80%"
                  :min="0"
                  v-model="temp.update.parallelism"
                  placeholder="并行度,同一时间升级的容器数量"
                />
              </a-form-item>
              <a-form-item label="延迟" prop="delay">
                <a-input-number
                  style="width: 80%"
                  :min="1"
                  v-model="temp.update.delay"
                  placeholder="延迟,容器升级间隔时间"
                />
              </a-form-item>
              <a-form-item label="失败率" prop="maxFailureRatio">
                <a-input-number
                  style="width: 80%"
                  :min="0"
                  v-model="temp.update.maxFailureRatio"
                  placeholder="失败率,更新期间允许的失败率"
                />
              </a-form-item>
              <a-form-item label="失败策略" prop="failureAction">
              ...
              <a-form-item label="执行顺序" prop="order">
              ...
              <a-form-item label="监控" prop="monitor">
                <a-input-number
                  style="width: 80%"
                  :min="1"
                  v-model="temp.update.monitor"
            ...
            <a-tab-pane key="rollback" tab="回滚策略" v-if="temp.rollback">
              <a-form-item label="并行度" prop="parallelism">
                <a-input-number
                  style="width: 80%"
                  :min="0"
                  v-model="temp.rollback.parallelism"
                  placeholder="并行度,同一时间升级的容器数量"
                />
              </a-form-item>
              <a-form-item label="延迟" prop="delay">
              ...
              <a-form-item label="失败率" prop="maxFailureRatio">
                <a-input-number
                  style="width: 80%"
                  :min="0"
                  v-model="temp.rollback.maxFailureRatio"
                  placeholder="失败率,更新期间允许的失败率"
                />
              </a-form-item>
              <a-form-item label="失败策略" prop="failureAction">
              ...
              <a-form-item label="预占资源">
                <a-row>
                  <a-col :span="8">
                    <a-input
                      addon-before="CPUs"
                      v-model="temp.resources.reservations.nanoCPUs"
                  ...
                  <a-col :span="8" :offset="1">
                    <a-input
                      addon-before="memory"
                      v-model="temp.resources.reservations.memoryBytes"
              ...
              <a-form-item label="限制资源">
                <a-row>
                  <a-col :span="8">
                    <a-input
                      addon-before="CPUs"
                      v-model="temp.resources.limits.nanoCPUs"
                      placeholder="nanoCPUs 最小 1000000"
                    />
                  </a-col>
                  <a-col :span="8" :offset="1">
                    <a-input
                      addon-before="memory"
                      v-model="temp.resources.limits.memoryBytes"
                      placeholder="memory 最小 4M"
                    />
                  </a-col>
                </a-row>
