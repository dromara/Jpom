<template>
  <div class="node-full-content">
    ...
    <a-form ref="editForm" :model="temp" :label-col="{ span: 6 }" :wrapper-col="{ span: 14 }">
      ...
      <a-form-item label="Nginx 白名单路径" prop="nginx">
        <a-input
          v-model="temp.nginx"
          type="textarea"
          :rows="5"
      ...
      <a-form-item label="Nginx 安装路径" prop="nginxPath">
        <a-input
          v-model="temp.nginxPath"
          placeholder="请输入 nginx安装路径,一般情况下无需配置，windows 下建议配置 nginx 安装的绝对路径,用于能 reload nginx "
        />
      </a-form-item>
