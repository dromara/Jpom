  ...
  <div class="user-header">
          ...
          <a-row>
            ...
            <a-col :span="12">
              <a-form ref="mfaForm" :model="temp" :rules="rules" :label-col="{ span: 6 }" :wrapper-col="{ span: 14 }">
                ...
                <a-form-item v-if="temp.needVerify" label="验证码" prop="twoCode">
                ...
                <!-- 不能使用  template 包裹 否则验证不能正常启用 -->
                <a-form-item v-if="!temp.needVerify && temp.status" label="验证码" prop="twoCode">
                  <a-input v-model="temp.twoCode" ref="twoCode" placeholder="两步验证码" />
                </a-form-item>
    ...
    >
      <a-form ref="userForm" :rules="rules" :model="temp" :label-col="{ span: 8 }" :wrapper-col="{ span: 15 }">
        ...
        <a-form-item label="长期token" prop="md5Token">
        ...
        <a-form-item label="邮箱地址" prop="email">
          <a-input v-model="temp.email" placeholder="邮箱地址" />
        </a-form-item>
        <a-form-item v-show="showCode" label="邮箱验证码" prop="code">
          <a-row :gutter="8">
            <a-col :span="15">
        ...
        <a-form-item label="钉钉通知地址" prop="dingDing">
    ...
    <a-modal destroyOnClose v-model="customizeVisible" title="个性配置区" :footer="null" :maskClosable="false">
      <a-form :model="temp" :label-col="{ span: 6 }" :wrapper-col="{ span: 14 }">
        ...
        <a-form-item label="页面导航" prop="token">
          <a-space>
            <a-switch
              checked-children="开"
              @click="toggleGuide"
        ...
        <a-form-item label="菜单配置" prop="token">
          <a-space>
            同时展开多个：
            <a-switch
              checked-children="是"
        ...
        <a-form-item label="页面配置" prop="token">
          <a-space>
            自动撑开：
            <a-switch
              checked-children="是"
        ...
        <a-form-item label="滚动条显示" prop="token">
          <a-space>
            全局配置：
            <a-switch
              checked-children="显示"
