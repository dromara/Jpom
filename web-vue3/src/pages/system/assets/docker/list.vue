  ...
  <div class="full-content">
    ...
    >
      <a-form ref="editForm" :rules="rules" :model="temp" :label-col="{ span: 4 }" :wrapper-col="{ span: 18 }">
        ...
        <a-form-item label="TLS 认证" prop="tlsVerify">
    ...
    >
      <a-form ref="joinForm" :rules="rules" :model="temp" :label-col="{ span: 4 }" :wrapper-col="{ span: 18 }">
        ...
        <a-form-item v-if="temp.remoteAddr" label="集群IP" prop="remoteAddr"
          ><a-input v-model="temp.remoteAddr" placeholder="关联容器标签" />
        </a-form-item>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          align: 'center',
          ellipsis: true,
          scopedSlots: { customRender: 'tlsVerify' }
        },
