layui.use(['layer', 'element', 'table', 'form'], function() {
	...
	table.render({
		...
		even: true,
		cols: [[
			{field: 'id', title: '项目名称', width: '100'},
			{field: 'tag', title: 'Tag', width: '200'},
			{field: 'mainClass', title: 'MainClass', width: '250'},
			{field: 'lib', title: 'Lib', width: '100'},
			{field: 'log', title: 'Log', width: '150'},
			{field: 'port', title: 'Port', width: '100'},
			{field: 'token', title: 'Token', width: '100'},
			{field: 'createTime', title: '创建时间', width: '200'},
			{field: 'op', title: '操作', width: '230', align: 'center', toolbar: '#bar_projects', fixed:'right'}
		]],
		loading: true,
		response: {
			statusCode: 200
