...
import cn.keepbx.jpom.socket.AgentWebSocketHandle;
...
public class EditProjectController extends BaseJpomController {
    @Resource
    ...
    private String checkParameter(ProjectInfoModel projectInfo, String whitelistDirectory) {
        ...
        if (AgentWebSocketHandle.SYSTEM_ID.equals(id)) {
            return JsonMessage.getString(401, "项目id " + AgentWebSocketHandle.SYSTEM_ID + " 关键词被系统占用");
        }
        // 防止和Jpom冲突
